...
import GoogleMapsLocationPicker from '../GoogleMapsLocationPicker.jsx';

const blankEvent = { title: '', category: 'Networking', date: '', endDate: '', location: '', latitude: null, longitude: null, description: '', image_url: '' };
